...
class PreProcess_Exemplars
{
	...
	public static String removeDublicateExemplars(String file)
	{
		...
		try
		{
			pw = new PrintWriter(file+"-no_dupes.dat");
		}
		catch(Exception e)
		{
			System.out.println("Error creating file");
	...
	public static String sameInputDiffOutput(String file)
	{
		...
		try
		{
			pw = new PrintWriter(file+"highest_on_out_chosen.dat");
		}
		catch(Exception e)
		{
			System.out.println("Error creating file");
		...
		pw.close();
		return file+"highest_on_out_chosen.dat";
	}
