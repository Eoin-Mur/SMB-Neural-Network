<?php
			...
			//on load if data was posted to the page. get the input
			...
			//gets the string enters splits to array
			//passes area to reply to get a reply bases of what user said.
			function readInput()
			{
				global $chatLog;
				$inputString = $_POST["user-input"];
				$chatLog = $_POST["log"];
...
<html>
	<body>
		<div name="chatWindow" style="display:inline-block;vertical-align:top;">
			<form method="post" action="mgonz.php">
				<textarea type="text" name="log" rows="25" cols="35" readonly><?php echo $chatLog;?></textarea>
				<br>
				<input type="text" name="user-input" autocomplete="off" autofocus/>
				<input type="submit" value="send" name="submit"/>
				<input type="submit" value="clear" name="clear"/>
			</form>
		</div>
		<div name="text" style="display:inline-block;vertical-align:top;width:300px">
			<h1>PHP implemenation of Mgonz chatter bot</h1>
			<br>
			<a style="font-size:25px;" href="http://computing.dcu.ie/~humphrys/Turing.Test/08.chapter.html">Paper on Mgonz</a>
			<br>
			<a style="font-size:25px;" href="http://computing.dcu.ie/~humphrys/Eliza/mgonz.lsp.html">Original Lisp source</a>
			<br>
			<p>TODO: Connect mgonz to twitter!</p> 
		</div>
		...
		<script>
		//code to make sure the text box is always scolled to the bottom on load!!!
		var textarea = document.getElementsByName('log')[0];
