...
class PreProcess_Exemplars
{
	...
	public static String countDistinctExemplars(String file)
	{
		...
		try
		{
			pw = new PrintWriter("../Pre-Processed_Exemplars/"+file+"-Count.dat");
		}
		catch(Exception e)
		{
	...
	public static String removeDublicateExemplars(String file)
	{
		...
		try
		{
			pw = new PrintWriter("../Pre-Processed_Exemplars/"+file+"_ND.dat");
		}
		catch(Exception e)
		{
			System.out.println("Error creating file");
	...
	public static String sameInputDiffOutput(String file)
	{
		...
		try
		{
			pw = new PrintWriter("../Pre-Processed_Exemplars/"+file+"_HOOC.dat");
		}
		catch(Exception e)
		{
			System.out.println("Error creating file");
